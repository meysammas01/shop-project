...
<body>
    <div class="container">
        ...
        <section class="about">
            <h1>درباره ما</h1>
            <p>فروشگاه <strong>ما</strong> با ارائه جدیدترین محصولات دیجیتال، شامل موبایل، لپ‌تاپ، کنسول‌های بازی و لوازم جانبی، تجربه‌ای متفاوت از خرید آنلاین را برای شما فراهم می‌کند.</p>
